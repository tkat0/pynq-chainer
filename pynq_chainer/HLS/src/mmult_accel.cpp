...
#pragma HLS dataflow
#pragma HLS array_partition variable=bram_w cyclic factor=32 dim=1
...
void xnor_mult(inter_t bram_w[MAX_H][MAX_X], outer_t x[MAX_X], outer_t h[MAX_H], uint16_t n_x, uint16_t n_h) {
#pragma HLS INLINE self
