...
class BinMmult():
    def __init__(self):
        self.ffi = cffi.FFI()
        if IS_PYNQ:
            bitfile = "../pynq_chainer/HLS/binmmult.bit"
            libfile = "../pynq_chainer/HLS/src/libbinmmult.so"
            self.ffi.cdef("int _Z17_p0_mmult_accel_0PfS_S_iii(unsigned int*, unsigned int*, unsigned int*, int, int, int);")
